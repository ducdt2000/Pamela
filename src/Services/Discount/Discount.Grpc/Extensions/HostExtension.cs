...
namespace Discount.Grpc.Extensions
{
    public static class HostExtension
    {
        ...
        private static void ExecuteMigrations(IConfiguration configuration)
        {
            ...
            command.CommandText = "INSERT INTO Coupon(ProductName, Description, Amount) VALUES('giay1', 'Discount Giày', 150);";
            command.ExecuteNonQuery();

            command.CommandText = "INSERT INTO Coupon(ProductName, Description, Amount) VALUES('dep2', 'Discount Dép 2', 100);";
            command.ExecuteNonQuery();
        }
    }
}
